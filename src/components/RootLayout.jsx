...
function Navigation() {
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        <NavigationItem href="/droit-famille">
          Droit de la famille
        </NavigationItem>
        <NavigationItem href="/droit-penal">Droit pénal</NavigationItem>
      </NavigationRow>
      <NavigationRow>
        <NavigationItem href="/about">Le Cabinet</NavigationItem>
        <NavigationItem href="/blog">Actualités</NavigationItem>
      </NavigationRow>
    </nav>
  )
}
