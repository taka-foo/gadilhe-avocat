...
export const metadata = {
  ...
  description:
    'Restez informé des dernières évolutions en droit de la famille et en droit pénal. Maître Julia GADILHE partage son expertise juridique.',
}
  ...
  return (
    <RootLayout>
      <PageIntro
        ...
        title="Les dernières évolutions du droit"
      >
        <p>
          Restez informé des dernières évolutions en droit de la famille et en
          droit pénal. Maître Julia GADILHE partage son expertise et analyse les
